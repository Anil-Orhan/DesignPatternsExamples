...
namespace WebApp.Strategy.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                settings.DatabaseType = (EDatabaseType) int.Parse(User.Claims.First(p => p.Type == Settings.claimDatabaseType).Value);
            }
            else
            {
        ...
        public async Task<IActionResult>  ChangeDatabase(int databaseType)
        {
            ...
            var hasDatabaseTypeClaim = claims.FirstOrDefault(p => p.Type == Settings.claimDatabaseType);
